    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
                ...
                <div className="flex items-center gap-2 bg-primary-50 dark:bg-primary-900/30 px-3 py-1 rounded-full text-primary-700 dark:text-primary-300 text-sm font-medium mb-6">
                    <Award size={14} />
                    {user.tier} Tier
                </div>
                ...
                <div className="flex gap-4 w-full justify-center">
                    <button className="flex flex-col items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors group">
                        <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center group-hover:bg-primary-50 dark:group-hover:bg-primary-900/30 transition-colors">
                            <Phone size={18} />
                        </div>
